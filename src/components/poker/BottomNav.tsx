...
import { LayoutGrid, Wallet, Clock, Users, Percent, AlertCircle, UserCircle, BarChart3 } from 'lucide-react';
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border safe-area-bottom print:hidden">
